...
<div class="dmd-container">
  <div class="second-container">
    <div class="header">
      <h1 id="title">Réclamation des incidents</h1>
    </div>
    <form action="" id="survey-form">
      ...
      <fieldset>
        <legend> <i class="fa-solid fa-chevron-down"></i>Détails de l'incident</legend>
        <div id="wrapwrap">
        <div class="field-container">
          <label for="titre">Nom de l'entité</label>
        ...
        <fieldset>
            <legend> <i class="fa-solid fa-chevron-down"></i>Personne effectuant la déclaration </legend>
          <div class="field-container">
     ...
     <fieldset>
        <legend><i class="fa-solid fa-chevron-down"></i>Qualification de l'incident
</legend>

          
            <div id="wrapwrap" style=" height:40px; margin-bottom:40px">
              <div class="field-container" >
                  <label>Origine de l'incident</label>
                    
                    <div name="state" class="custom-select" style="width:300px; height:40px">
                      <select name="qualification">
                        <option disabled>cocher la case correspondante</option>
                        <option name = "qualification" value="qualification ">☐ Malveillance</option>
                        <option name = "qualification" value="qualification ">☐ Accident</option>
                        <option name = "qualification" value="qualification ">☐ Inconnue</option>
              ...
              <div class="field-container" >
                  <label><p>En cas d'incident d'origine malveillante</p></label>
                    
                    <div name="state" class="custom-select" style="width:300px; height:40px">
                      <select name="qualification">
                        <option disabled>Précisez l'origine de la malveillance</option>
                        <option name = "qualification" value="qualification ">☐  Interne  </option>
                        <option name = "qualification" value="qualification ">☐ Externe</option>
                        <option name = "qualification" value="qualification ">☐ Inconnue</option>
      ...
      <fieldset>
        ...
        <div id="wrapwrap">
        <div class="field-container">
          <label for="titre">Nom-Prénom</label>
          <input type="text" name="nom_prenom" id="titre">
        </div>
        <div class="field-container">
          <label for="titre">Fonction</label>
          <input type="text" name="Fonction*" id="titre">
        </div>
        <div class="field-container">
          <label for="titre">Téléphone bureau</label>
          <input type="number" name="telephone" id="titre">
        </div>
        <div class="field-container">
          <label for="titre">Adresse électronique</label>
